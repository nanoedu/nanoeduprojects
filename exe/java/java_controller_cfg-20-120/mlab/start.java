...
public class start
{
	...
	int[] r;
		...
		/*
			Запись конфигурации. -20;120 V
		*/
		XYZCFG_V1 cfg = new XYZCFG_V1( );

		cfg.DAC( 0, 0x49249249, XYZCFG_V1.NOINV );
		cfg.OSC( 0, 0x0000A0C1, 0x0000A042, "DAC_X" );
 
		cfg.DAC( 1, 0x49249249, XYZCFG_V1.NOINV );
		cfg.OSC( 1, 0x0000A0C1, 0x0000A042, "DAC_Y" );

		cfg.DAC( 2, 0x49249249, XYZCFG_V1.NOINV );
		cfg.OSC( 2, 0x0000A0C1, 0x0000A042, "DAC_Z" );
