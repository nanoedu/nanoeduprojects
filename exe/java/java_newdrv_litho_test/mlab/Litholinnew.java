...
// Вектор перемещения и позиция точки
                code[5]  = 0x00000000 + (20<<16) + (0<<0);
		code[6]  = 0x20000000;
		// Контроль перемещения
                code[7]  = 0x00000000;
		code[8]  = 0x10000008;    //?????
                // Считывание после паузы
                code[9]  = 0x00000000 + (0<<16) + (25<<0);
                code[10] = 0x40000000 + pause - 1;
// перемещения по z dz
                code[11]  = 0x00000000 + (27<<16) + (0<<0);
		code[12]  = 0x20000000;
		// Контроль перемещения
                code[13]  = 0x00000000;
		code[14]  = 0x10000008;
...
// перемещения по z -dz
                code[15]  = 0x00000000 + (27<<16) + (0<<0);
		code[16]  = 0x20000000;
		// Контроль перемещения
                code[17]  = 0x00000000;
		code[18]  = 0x10000008;
// Возврат
                code[19] = 0x80000000 + (5<<16) + 0;
