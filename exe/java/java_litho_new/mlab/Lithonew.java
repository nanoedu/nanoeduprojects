package mlab;  //litho new 20/02/13

		// 21/02/13 -REad matrix Data from stream  CH_DATA_IN
...
// for (i=0;i<12; i++)  { Simple.DumpInt(datain[i]);}
		...
		JVIO stream_ch_data_out  = new JVIO(CH_DATA_OUT,1,2*SZ*X_POINTS*Y_POINTS,JVIO.FIFO,SZ*fastlines, 0);  // 2
                ...
                JVIO stream_ch_data_in   = new JVIO(CH_DATA_IN ,X_POINTS*Y_POINTS, 1,JVIO.FIFO, 1, 0);       // 4
