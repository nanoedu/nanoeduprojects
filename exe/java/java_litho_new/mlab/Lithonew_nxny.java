package mlab;  //litho new 20/02/12

public class Lithonew
{
...
//     	static final int PORT_ZuVector = ( Port.OUT | 6 );
	...
	public static final int CH_DATA_OUT    = 2;
        ...
        public static final int CH_DATA_IN     = 4;
	...
	public static void main(String[] arg)
	{
		...
		maskin = new int[X_POINTS*Y_POINTS];
...
// for (i=0;i<12; i++)  { Simple.DumpInt(datain[i]);}
		...
		JVIO stream_ch_data_out  = new JVIO(CH_DATA_OUT,1,2*SZ*X_POINTS*Y_POINTS,JVIO.FIFO,SZ*fastlines, 0);  // 2
                JVIO stream_ch_params    = new JVIO(CH_PARAMS, 4, 1,JVIO.BUF,  1, 0);
               // JVIO stream_ch_data_in   = new JVIO(CH_DATA_IN ,X_POINTS*Y_POINTS, 1,JVIO.FIFO, 1, 0);  
		JVIO stream_ch_data_in   = new JVIO(CH_DATA_IN ,1,X_POINTS*Y_POINTS, JVIO.FIFO, 1, 0);                     // 3
