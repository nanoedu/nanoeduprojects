...
uses
  ...
  XMLFiles in '..\sources\ntmdt\XMLFiles.pas',
  ResMgr in '..\sources\ntmdt\ResMgr.pas',
  BaseUtils in '..\sources\ntmdt\BaseUtils.pas',
  BaseTypes in '..\sources\ntmdt\BaseTypes.pas',
  BaseClasses in '..\sources\ntmdt\BaseClasses.pas',
  IniFilesEx in '..\sources\ntmdt\IniFilesEx.pas',
  TextData in '..\sources\TextData.pas',
  frProfiler in '..\sources\frProfiler.pas' {Profiler},
  ThreadDrawProfile in '..\sources\ThreadDrawProfile.pas';
