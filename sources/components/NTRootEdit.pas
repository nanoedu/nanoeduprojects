...
uses
  ...
  DesignIntf, DesignEditors, StdCtrls, NTShellCtrls;
...
type
  ...
  TNTRootEditor = class(TComponentEditor)
  public
...
procedure TNTRootEditor.ExecuteVerb(Index: Integer);
...
function TNTRootEditor.GetVerb(Index: Integer): String;
begin
  case Index of
  0 : Result := SEditRoot;
  end;
...
function TNTRootEditor.GetVerbCount: Integer;
begin
  Result := 1;
end;
