...
procedure Tfarplugin.CopyPlugInFiles;
   var reg:Tregistry;
...
procedure Tfarplugin.FormShow(Sender: TObject);
begin
   timer.interval:=0;
   CopyPlugInFiles;
   timer.interval:=1000;
...
procedure Tfarplugin.TimerTimer(Sender: TObject);
begin
    Close;
end;
