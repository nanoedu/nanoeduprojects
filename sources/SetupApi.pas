...
type SP_DRVINFO_DATA_A = packed record
         cbSize:DWORD;
         DriverType:DWORD;
     Reserved:ULONG_PTR;
     Description: array [0..LINE_LEN] of CHAR;
    ...
    PSPDriverInfoData=PSP_DRVINFO_DATA_A;
type
 _SP_DRVINFO_DETAIL_DATA = packed record
       cbSize: DWORD;
     InfDate:FILETIME;
        CompatIDsOffset:DWORD;
        CompatIDsLength:DWORD;
     Reserved:ULONG_PTR;
         SectionName:array[0..LINE_LEN] of CHAR;
         InfFileName:array[0..MAX_PATH] of CHAR;
         DrvDescription:array[0..LINE_LEN] of CHAR;
     HardwareID:array[0..ANYSIZE_ARRAY] of CHAR   ;
end;
...
function SetupDiOpenDeviceInfoA(DeviceInfoSet: HDEVINFO;
  ...
  DeviceInfoData: TSPDevInfoData): LongBool; stdcall;
...
function SetupDiBuildDriverInfoList(DeviceInfoSet: HDEVINFO;
  DeviceInfoData: TSPDevInfoData; DriverType: DWORD): LongBool; stdcall;
...
function SetupDiGetSelectedDriverA(DeviceInfoSet: HDEVINFO;
  DeviceInfoData: TSPDevInfoData; var DriverInfoData: TSPDrvInfoDataA): LongBool; stdcall;
{$EXTERNALSYM SetupDiGetSelectedDriverA}
function SetupDiGetSelectedDriverW(DeviceInfoSet: HDEVINFO;
  DeviceInfoData: TSPDevInfoData; var DriverInfoData: TSPDrvInfoDataW): LongBool; stdcall;
{$EXTERNALSYM SetupDiGetSelectedDriverW}
function SetupDiGetSelectedDriver(DeviceInfoSet: HDEVINFO;
  DeviceInfoData: TSPDevInfoData; var DriverInfoData:TSPDRVINFODATAA{ TSPDrvInfoDataA}): LongBool; stdcall;
...
function SetupDiCallClassInstaller(InstallFunction: DI_FUNCTION;
  DeviceInfoSet: HDEVINFO; DeviceInfoData: TSPDevInfoData): LongBool; stdcall;
...
//
  ...
  TSetupDiSetSelectedDevice = function(DeviceInfoSet: HDEVINFO;
    var DeviceInfoData:PSPDevInfoData{ TSPDevInfoData}): LongBool; stdcall;
