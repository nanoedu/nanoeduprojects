...
type
  TArrayOfShortInt = array[0..$7FFFFFFE] of ShortInt;
  TArrayOfByte = array[0..$7FFFFFFE] of Byte;
  TArrayOfAnsiChar = array[0..$7FFFFFFE] of AnsiChar;
  TArrayOfSmallInt = array[0..$3FFFFFFE] of SmallInt;
  TArrayOfWord = array[0..$3FFFFFFE] of Word;
  TArrayOfInteger = array[0..$1FFFFFFE] of Integer;
  TArrayOfCardinal = array[0..$1FFFFFFE] of Cardinal;
  TArrayOfInt64 = array[0..$0FFFFFFE] of Int64;
  TArrayOfReal48 = array[0..$015555554] of Real48;
  TArrayOfSingle = array[0..$1FFFFFFE] of Single;
  TArrayOfDouble = array[0..$0FFFFFFE] of Double;
  TArrayOfExtended = array[0..$0CCCCCCB] of Extended;
  TArrayOfComp = array[0..$0FFFFFFE] of Comp;
  TArrayOfCurrency = array[0..$0FFFFFFE] of Currency;
  ...
  TArrayOfBoolean = array[0..0] of Boolean;
  PArrayOfBoolean = ^TArrayOfBoolean;
  TArrayOfPointer = array[0..0] of Pointer;
  ...
  TArrayOfPoint = array[0..0] of TPoint;
  PArrayOfRect = ^TArrayOfRect;
  TArrayOfRect = array[0..0] of TRect;
  PArrayOfDataRect = ^TArrayOfDataRect;
  TArrayOfDataRect = array[0..0] of TDataRect;
  PArrayOfPhysRect = ^TArrayOfPhysRect;
  TArrayOfPhysRect = array[0..0] of TPhysRect;
  TArrayOfRGBQuad = array[0..0] of TRGBQuad;
  PArrayOfRGBQuad = ^TArrayOfRGBQuad;
  TArrayOfRGBTriple = array[0..0] of TRGBTriple;
  PArrayOfRGBTriple = ^TArrayOfRGBTriple;

  TArrayOfComplex = array[0..MaxLongint div SizeOf(Complex) - 1] of Complex;
  PArrayOfComplex = ^TArrayOfComplex;
  TArrayOfGUID = array[0..0] of TGUID;
...
function DataTypeMemSize(DataType: Integer): Byte;
...
function IsPhysZero( AValue: Double ): Boolean;
function NotPhysZero( AValue: Double ): Boolean;
function IsPhysSame( AValue1, AValue2: Double ): Boolean;
function NotPhysSame( AValue1, AValue2: Double ): Boolean;
function IsPhysLess( AValue1, AValue2: Double ): Boolean;
function IsPhysLarger( AValue1, AValue2: Double ): Boolean;
function IsPhysEqualLess( AValue1, AValue2: Double ): Boolean;
function IsPhysEqualLarger( AValue1, AValue2: Double ): Boolean;
...
function IsPhysZero( AValue: Double ): Boolean;
begin
  Result := IsZero(AValue, MinPhysValue);
end;
//------------------------------------------------------------------------------
function NotPhysZero( AValue: Double ): Boolean;
begin
  Result := not IsZero(AValue, MinPhysValue);
end;
//------------------------------------------------------------------------------
function IsPhysSame( AValue1, AValue2: Double ): Boolean;
begin
  Result := IsZero(AValue1 - AValue2, MinPhysValue);
end;
//------------------------------------------------------------------------------
function NotPhysSame( AValue1, AValue2: Double ): Boolean;
begin
  Result := not IsPhysSame(AValue1, AValue2);
end;
//------------------------------------------------------------------------------
function IsPhysLess( AValue1, AValue2: Double ): Boolean;
begin
  Result := (AValue1 < AValue2) and not IsZero(AValue1 - AValue2, MinPhysValue);
end;
//------------------------------------------------------------------------------
function IsPhysLarger( AValue1, AValue2: Double ): Boolean;
begin
...
function IsPhysEqualLess( AValue1, AValue2: Double ): Boolean;
begin
  Result := (AValue1 < AValue2) or IsZero(AValue1 - AValue2, MinPhysValue);
end;
//------------------------------------------------------------------------------
function IsPhysEqualLarger( AValue1, AValue2: Double ): Boolean;
begin
